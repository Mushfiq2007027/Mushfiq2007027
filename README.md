...
I build robust, well-architected software across full-stack web, mobile,
and hardware domains, then extend them with deep learning and data-driven
capabilities to tackle real-world problems.

My undergraduate thesis applies multimodal deep learning (clinical data +
ultrasound images) for liver disease classification — reflecting my core
interest in AI for healthcare and medical imaging.
...
![Scikit--learn](https://img.shields.io/badge/Scikit--learn-blue?style=flat)
![OpenCV](https://img.shields.io/badge/OpenCV-green?style=flat)
